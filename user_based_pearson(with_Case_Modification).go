...
Date: 3/13/2021
Description: This program implements the user-based pearson-correlation (with case modification)
...
func main() {
	...
	// Use training data to make predictions for testing data using pearson-correlation user-based collaborative filtering with case modification
	...
	// Print out the RMSE
	fmt.Printf("User-Based Pearson Correlation with Case Amplification RSME: %f \n", result)
}
